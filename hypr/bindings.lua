...
-- Vi-style window focus (replaces SUPER + arrow keys).
...
-- Vi-style window swap (replaces SUPER + SHIFT + arrow keys)
...
-- Displaced bindings from the vi focus keys, with new keys
o.bind("SUPER + U", "Toggle window split", hl.dsp.layout("togglesplit"))
-- Disable the default Passwords binding (prompts to install 1password)
...
-- Rectangle screenshot (was: Google Maps from preinstalled apps).
